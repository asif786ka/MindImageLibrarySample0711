...
package mindimagelibrary.sample.imageDB.controller;
...
import mindimagelibrary.sample.imageDB.MainActivity;
import mindimagelibrary.sample.imageDB.MovieDB;
import mindimagelibrary.sample.imageDB.R;
import mindimagelibrary.sample.imageDB.adapter.TVDetailsSlideAdapter;
import mindimagelibrary.sample.imageDB.helper.ObservableScrollViewCallbacks;
import mindimagelibrary.sample.imageDB.helper.ScrollState;
import mindimagelibrary.sample.imageDB.helper.Scrollable;
import mindimagelibrary.sample.imageDB.model.CastModel;
import mindimagelibrary.sample.imageDB.model.SeasonModel;
import mindimagelibrary.sample.imageDB.model.SimilarModel;
import mindimagelibrary.sample.imageDB.view.MovieDetailsSlidingTabLayout;
import mindimagelibrary.sample.imageDB.view.ObservableParallaxScrollView;
