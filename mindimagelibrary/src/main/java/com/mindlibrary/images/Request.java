...
public final class Request {
  ...
  public final MindLibImage.Priority priority;
  ...
  private Request(Uri uri, int resourceId, String stableKey, List<Transformation> transformations,
      ...
      boolean purgeable, Bitmap.Config config, MindLibImage.Priority priority) {
    this.uri = uri;
  ...
  public static final class Builder {
    ...
    private MindLibImage.Priority priority;
    ...
    public Builder priority(@NonNull MindLibImage.Priority priority) {
      if (priority == null) {
    ...
    public Request build() {
      ...
      if (priority == null) {
        priority = MindLibImage.Priority.NORMAL;
      }
