...
final class MindLibDrawable extends BitmapDrawable {
  ...
  static void setBitmap(ImageView target, Context context, Bitmap bitmap,
                        MindLibImage.LoadedFrom loadedFrom, boolean noFade, boolean debugging) {
    Drawable placeholder = target.getDrawable();
    if (placeholder instanceof AnimationDrawable) {
      ((AnimationDrawable) placeholder).stop();
    }
    MindLibDrawable drawable =
        new MindLibDrawable(context, bitmap, placeholder, loadedFrom, noFade, debugging);
  ...
  MindLibDrawable(Context context, Bitmap bitmap, Drawable placeholder,
                  MindLibImage.LoadedFrom loadedFrom, boolean noFade, boolean debugging) {
