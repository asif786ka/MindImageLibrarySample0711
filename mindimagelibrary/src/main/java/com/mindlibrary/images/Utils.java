...
import static com.mindlibrary.images.MindLibImage.TAG;
import static java.lang.String.format;

final class Utils {
  static final String THREAD_PREFIX = "MindLibImage-";
  static final String THREAD_IDLE_NAME = THREAD_PREFIX + "Idle";
  private static final String PICASSO_CACHE = "mindLibImage-cache";
  ...
  */
  ...
  static class MindLibraryThreadFactory implements ThreadFactory {
    @SuppressWarnings("NullableProblems")
    public Thread newThread(Runnable r) {
      return new MindLibraryThread(r);
    }
  }

  private static class MindLibraryThread extends Thread {
    public MindLibraryThread(Runnable r) {
      super(r);
    }
