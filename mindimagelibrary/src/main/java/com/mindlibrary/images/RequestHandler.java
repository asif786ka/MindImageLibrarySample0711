...
/**
 * {@code RequestHandler} allows you to extend MindLibImage to load images in ways that are not
 ...
 * {@link MindLibImage.Builder#addRequestHandler(RequestHandler)}
 * <p>
 * <b>Note:</b> This is a beta feature. The API is subject to change in a backwards incompatible
 * way at any time.
 *
 * @see MindLibImage.Builder#addRequestHandler(RequestHandler)
 */
public abstract class RequestHandler {
  ...
  public static final class Result {
    private final MindLibImage.LoadedFrom loadedFrom;
    private final Bitmap bitmap;
    private final Source source;
    private final int exifOrientation;

    public Result(@NonNull Bitmap bitmap, @NonNull MindLibImage.LoadedFrom loadedFrom) {
      this(Utils.checkNotNull(bitmap, "bitmap == null"), null, loadedFrom, 0);
    }

    public Result(@NonNull Source source, @NonNull MindLibImage.LoadedFrom loadedFrom) {
      this(null, Utils.checkNotNull(source, "source == null"), loadedFrom, 0);
    }

    Result(
        @Nullable Bitmap bitmap,
        @Nullable Source source,
        @NonNull MindLibImage.LoadedFrom loadedFrom,
        int exifOrientation) {
    ...
    /**
     * Returns the resulting {@link MindLibImage.LoadedFrom} generated from a
     * {@link #load(Request, int)} call.
     */
    @NonNull public MindLibImage.LoadedFrom getLoadedFrom() {
      return loadedFrom;
    }
