...
import static com.mindlibrary.images.TestUtils.TRANSFORM_REQUEST_ANSWER;
import static com.mindlibrary.images.TestUtils.URI_1;
import static com.mindlibrary.images.TestUtils.mockCallback;
import static com.mindlibrary.images.TestUtils.mockFitImageViewTarget;
...
public class DeferredRequestCreatorTest {
  ...
  @Test public void preDrawSubmitsRequestAndCleansUp() {
    ...
    when(mindLibImage.transformRequest(any(Request.class))).thenAnswer(TRANSFORM_REQUEST_ANSWER);

    RequestCreator creator = new RequestCreator(mindLibImage, URI_1, 0);
