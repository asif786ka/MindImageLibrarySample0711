...
import static com.mindlibrary.images.TestUtils.URI_2;
import static com.mindlibrary.images.TestUtils.URI_KEY_1;
import static com.mindlibrary.images.TestUtils.URI_KEY_2;
...
import static com.mindlibrary.images.TestUtils.mockNetworkInfo;
...
public class DispatcherTest {
  ...
  @Mock
  MindLibExecutorService service;
  ...
  @Test public void performRetryForContentLengthResetsNetworkPolicy() {
    ...
    when(hunter.getException()).thenReturn(new NetworkRequestHandler.ContentLengthException("304 error"));
  ...
  public void performNetworkStateChangeWithConnectedInfoAndPicassoExecutorServiceAdjustsThreads() {
    MindLibExecutorService service = mock(MindLibExecutorService.class);
    NetworkInfo info = mockNetworkInfo(true);
  ...
  private void setAndVerifyAirplaneMode(boolean airplaneOn) {
    ...
    intent.putExtra(Dispatcher.NetworkBroadcastReceiver.EXTRA_AIRPLANE_STATE, airplaneOn);
